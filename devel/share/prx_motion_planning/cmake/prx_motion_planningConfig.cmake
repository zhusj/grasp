...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'prx_motion_planning' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pracsys/grasp/src/prx_motion_planning/${idir}'.  Ask the maintainer 'Alberto Ferreira De Souza <alberto@lcad.inf.ufes.br>' to fix it.")
    endif()
