...
if("TRUE" STREQUAL "TRUE")
  set(gazebo_ros_SOURCE_PREFIX /home/pracsys/grasp/src/gazebo_ros_pkgs/gazebo_ros)
  set(gazebo_ros_DEVEL_PREFIX /home/pracsys/grasp/devel)
  ...
  set(gazebo_ros_INSTALL_PREFIX /home/pracsys/grasp/install)
...
if(NOT "/home/pracsys/grasp/devel/include;/usr/include" STREQUAL "")
  set(gazebo_ros_INCLUDE_DIRS "")
  set(_include_dirs "/home/pracsys/grasp/devel/include;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'gazebo_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pracsys/grasp/src/gazebo_ros_pkgs/gazebo_ros/${idir}'.  Ask the maintainer 'John Hsu <hsu@osrfoundation.org>, Dave Coleman <davetcoleman@gmail.com>' to fix it.")
    endif()
